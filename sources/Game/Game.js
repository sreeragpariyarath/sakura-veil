...
import { PhysicsFlight } from './Physics/PhysicsFlight.js'
    ...
    async init()
    {
        ...
        const resourcesPromise = this.resourcesLoader.load(
            [
                ...
                [ 'sakuraModel',                           `sakura.glb`,                                                                         'gltf' ],
                [ 'vehicle',                               `character/ghost.glb`,                                                                 'gltf' ],
                ...
                [ 'japanOldLampModel',                     `japan_old_lamp.glb`,                                                                 'gltf' ],
        ...
        this.physicalVehicle = new PhysicsFlight()
